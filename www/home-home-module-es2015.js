...
let HomePage = class HomePage {
    constructor(router, fb, api, toaster, authService, alertCtrl, loadingCtrl, navCtrl, pickerController, d) {
        this.router = router;
        this.fb = fb;
        this.api = api;
    ...
    doBook() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.api.add_ticket(localStorage.getItem('from'), localStorage.getItem('to'), localStorage.getItem('depart'), localStorage.getItem('return'), localStorage.getItem('adults'), localStorage.getItem('children'), localStorage.getItem('adult_price'), localStorage.getItem('child_price'), localStorage.getItem('meals')).subscribe(data => {
                if (data.status == 0) {
                    loading.dismiss();
