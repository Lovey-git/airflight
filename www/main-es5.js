(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(platform, splashScreen, statusBar, auth, route, popoverController, menu, actionSheetController, router) {
          ...
          var url = route.snapshot.url.join('home');
          console.log(url);
        }
        ...
        _createClass(AppComponent, [{
          ...
          key: "presentOptions0",
          value: function presentOptions0() {
          ...
          key: "presentOptions1",
          value: function presentOptions1() {
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this2.router.navigateByUrl('register');
                          }
                        }, {
                          text: 'Cancel',
                          icon: 'close',
    ...
    function srcProvidersListsDestinationTs(module, __webpack_exports__, __webpack_require__) {
      ...
      DestinationList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], DestinationList);
      /***/
    },
    ...
    function srcServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ApiService = /*#__PURE__*/function () {
        ...
        _createClass(ApiService, [{
          ...
          key: "add_ticket",
          value: function add_ticket(from, to, depart, Return, adults, children, adult_price, child_price, meals) {
            var uuid = localStorage.getItem('uuid');
