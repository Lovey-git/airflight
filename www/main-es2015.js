...
const routes = [
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() | home-home-module */[__webpack_require__.e("default~home-home-module~register-register-module"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(m => m.HomePageModule)
    },
    {
        path: '',
        redirectTo: 'home',
    ...
    {
        path: 'register',
        loadChildren: () => Promise.all(/*! import() | register-register-module */[__webpack_require__.e("default~home-home-module~register-register-module"), __webpack_require__.e("register-register-module")]).then(__webpack_require__.bind(null, /*! ./register/register.module */ "./src/app/register/register.module.ts")).then(m => m.RegisterPageModule)
    },
    {
        path: 'profile',
    ...
    {
        path: 'report',
        loadChildren: () => __webpack_require__.e(/*! import() | report-report-module */ "report-report-module").then(__webpack_require__.bind(null, /*! ./report/report.module */ "./src/app/report/report.module.ts")).then(m => m.ReportPageModule)
    },
    {
        path: 'tickets',
        loadChildren: () => __webpack_require__.e(/*! import() | tickets-tickets-module */ "tickets-tickets-module").then(__webpack_require__.bind(null, /*! ./tickets/tickets.module */ "./src/app/tickets/tickets.module.ts")).then(m => m.TicketsPageModule)
    },
    {
        path: 'bookings',
...
AppRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(routes, { onSameUrlNavigation: 'reload', preloadingStrategy: _angular_router__WEBPACK_IMPORTED_MODULE_2__["PreloadAllModules"] })
        ],
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, auth, route, popoverController, menu, actionSheetController, router) {
...
/* harmony import */ var _services_toaster_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/toaster.service */ "./src/services/toaster.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _providers_lists_province__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../providers/lists/province */ "./src/providers/lists/province.ts");
/* harmony import */ var _providers_lists_destination__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../providers/lists/destination */ "./src/providers/lists/destination.ts");
...
/* harmony import */ var ngx_mask__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ngx-mask */ "./node_modules/ngx-mask/__ivy_ngcc__/fesm2015/ngx-mask.js");
/* harmony import */ var _services_excel_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../services/excel.service */ "./src/services/excel.service.ts");
/* harmony import */ var angular_google_charts__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! angular-google-charts */ "./node_modules/angular-google-charts/__ivy_ngcc__/fesm2015/angular-google-charts.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _providers_lists_province__WEBPACK_IMPORTED_MODULE_14__["ProvinceList"],
            _providers_lists_destination__WEBPACK_IMPORTED_MODULE_15__["DestinationList"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DestinationList", function() { return DestinationList; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


let DestinationList = class DestinationList {
    constructor() {
...
DestinationList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProvinceList", function() { return ProvinceList; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


let ProvinceList = class ProvinceList {
    constructor() {
...
ProvinceList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], ProvinceList);
...
let ApiService = class ApiService {
    ...
    register(email, password, lname, fname) {
        return this.http.post(this._Url + 'register', { email, password, fname, lname });
    }
    //UPDATE USER
    update_user(fname, lname, email, cell, gender, province, dob) {
        var uuid = localStorage.getItem('uuid');
        return this.http.post(this._Url + 'update_user', { fname, lname, email, cell, gender, province, uuid, dob });
    }
    //UPDATE PASSWORD
    update_password(password) {
        var uuid = localStorage.getItem('uuid');
        return this.http.post(this._Url + 'update_password', { password, uuid });
    }
    //Reset PASSWORD
    ...
    //Remove user
    remove_user(uuid) {
        return this.http.post(this._Url + 'delete_user', { uuid });
    }
    //add ticket
    add_ticket(from, to, flight_type, depart, Return, adults, children, adult_price, child_price, meals, Class, totalAmt, time_slot, username) {
        var uuid = localStorage.getItem('uuid');
        return this.http.post(this._Url + 'add_ticket', { uuid, from, to, flight_type, depart, Return, adults, children, adult_price, child_price, meals, Class, totalAmt, time_slot, username });
    }
    add_ticket2(from, to, flight_type, depart, Return, adults, children, adult_price, child_price, DepartMeals, ReturnMeals, Class, totalAmt, time_slot, return_time_slot, username) {
        var uuid = localStorage.getItem('uuid');
        return this.http.post(this._Url + 'add_ticket', { uuid, from, to, flight_type, depart, Return, adults, children, adult_price, child_price, DepartMeals, ReturnMeals, Class, totalAmt, time_slot, return_time_slot, username });
    }
    //get all users
    ...
    get_all_users_by_search(searchText) {
        return this.http.post(this._Url + 'get_all_users_by_search', { searchText });
    }
    get_all_users() {
    ...
    register_as_admin(uuid, ur) {
        return this.http.post(this._Url + 'register_admin', { uuid, ur });
    }
    //add user payment
    add_user_payment(ticket_id, amount, card_number, cvv, expire_date) {
        return this.http.post(this._Url + 'add_user_payment', { ticket_id, amount, card_number, cvv, expire_date });
    }
    //add user payment
    get_user_tickets(searchText) {
        var uuid = localStorage.getItem('uuid');
        return this.http.post(this._Url + 'get_user_tickets', { searchText, uuid });
    }
    //add user payment
    generate_report(data) {
        return this.http.post(this._Url + 'generate_report', { data });
    }
    //add user payment
    deactivate_user() {
        var uuid = localStorage.getItem('uuid');
        return this.http.post(this._Url + 'deactivate_user', { uuid });
    }
    //activate user 
    activate_user(email) {
        return this.http.post(this._Url + 'activate_user', { email });
    }
    //get_all_bookings 
    get_all_bookings(searchText) {
        return this.http.post(this._Url + 'get_all_bookings', { searchText });
    }
};
...
let AuthService = class AuthService {
    ...
    login(email, password) {
        return this.http.post(this.api._Url + 'login', { email, password });
    }
    auth(uuid) {
    ...
    get_user() {
        var uuid = localStorage.getItem('uuid');
        return this.http.post(this.api._Url + 'getUser', { uuid });
    }
    logout() {
...
module.exports = __webpack_require__(/*! C:\Users\user\Desktop\fun apps\air-flight\src\main.ts */"./src/main.ts");
