...
/* harmony default export */ __webpack_exports__["default"] = ("<ion-app>\n  <ion-header>\n    <ion-toolbar>\n      <ion-item lines=\"none\">\n        <ion-item lines=\"none\" slot=\"start\">\n          <ion-title slot=\"start\" routerLink=\"/home\">\n            {{title}}\n          </ion-title>\n         \n        </ion-item>\n        <ion-item lines=\"none\" slot=\"end\">\n          <ion-title *ngIf=\"role=='admin'\">(Admin) </ion-title>\n          <!-- <ion-icon *ngIf=\"!isLoggedIn\" (click)=\"presentOptions1()\"  slot='end' name=\"options-outline\"></ion-icon> -->\n          <ion-icon *ngIf=\"isLoggedIn && role=='normal'\" (click)=\"presentOptions0()\"  slot='end' name=\"options-outline\"></ion-icon>\n          <ion-icon *ngIf=\"role=='admin' && isLoggedIn\"  (click)=\"presentOptions0()\" slot='end' name=\"options-outline\"></ion-icon>\n        </ion-item>\n\n      </ion-item>\n    </ion-toolbar>\n  </ion-header>\n  <ion-router-outlet></ion-router-outlet>\n</ion-app>");
...
let DestinationList = class DestinationList {
    constructor() {
        this.destination_list = ["King Mswati III International Airport SHO", "Cape Town CPT", "Bloemfontain BFN", "Windhoek WDH", "Port Elizabeth PLZ", "Durban DUR"];
    }
};
...
let ProvinceList = class ProvinceList {
    constructor() {
        this.Province_list = ["Eastern Cape", "Free State", "Gauteng", "KwaZulu-Natal", "Limpopo", "Mpumalanga", "Northern Cape"];
    }
};
...
let ApiService = class ApiService {
    ...
    register(email, password, lname, fname) {
        return this.http.post(this._Url + 'register', { email, password, lname, fname });
    }
    //UPDATE USER
    ...
    add_ticket(from, to, depart, Return, adults, children, adult_price, child_price, meals) {
        var uuid = localStorage.getItem('uuid');
        return this.http.post(this._Url + 'add_ticket', { uuid, from, to, depart, Return, adults, children, adult_price, child_price, meals });
    }
    //get all users
    get_all_users() {
