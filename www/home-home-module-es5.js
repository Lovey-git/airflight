(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      "./src/providers/lists/destination.ts"); // import { PayPal, PayPalPayment, PayPalConfiguration } from '@ionic-native/paypal/ngx';


      var HomePage = /*#__PURE__*/function () {
        function HomePage(router, fb, api, toaster, authService, alertCtrl, loadingCtrl, navCtrl, pickerController, d) {
          ...
          this.d = d;
          this.destination_list = ["Cape Town CPT", "Bloemfontain BFN", "Windhoek WDH", "Port Elizabeth PLZ", "Durban DUR"];
          this.meals = ["fish and chips", "chicken", "beef", "fish", "pasta", "halal", "cocktail", 'cola'];
          this.selectedMeals = new Array();
          this.Destinations = this.d.destination_list;
          this.index = 0;
          this.minDate = moment__WEBPACK_IMPORTED_MODULE_8__().add(1, 'd').format().toString();
          ...
          this.paymentForm = this.fb.group({
            ...
            card_expMonth: [this.minDate, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
              ...
              return regeneratorRuntime.wrap(function _callee7$(_context7) {
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    ...
                    case 5:
                      this.api.add_ticket(localStorage.getItem('from'), localStorage.getItem('to'), localStorage.getItem('depart'), localStorage.getItem('return'), localStorage.getItem('adults'), localStorage.getItem('children'), localStorage.getItem('adult_price'), localStorage.getItem('child_price'), localStorage.getItem('meals')).subscribe(function (data) {
                        if (data.status == 0) {
                          loading.dismiss();
